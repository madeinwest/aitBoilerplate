...
jQuery(function() {
	...
	jQuery('.lazy').Lazy({
		...
		jQuery('.slick-slider .lazy').Lazy({
			visibleOnly: true,
			effect: 'fadeIn',
			threshold:400,
			appendScroll: jQuery('.slick-slider'),
			delay:7000
		});
	});
	jQuery('.slick1').slick({
	...
	var sngd =document.getElementById('submit1');
var subm = document.getElementById("subm");
var inpChek = document.getElementById("test1");

if(sngd !== null){
	sngd.addEventListener( "click" , validation1);
	function validation1(e) {
		if (inpChek.checked === true){
		...
		jQuery('#request-form input[type=radio]:checked').each(function(){
			...
			sn_form_submit('request-form1','config_email_1');
			return
			}
	else{
		alert("You don't accept the private police");
		return
	}
	}
}
...
if(subm){
subm.addEventListener( "click" , validation);
